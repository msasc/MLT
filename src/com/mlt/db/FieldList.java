...
/**
 * A field list packs a list of field, its field map, the primary key pointers
 * and the order key pointers if applicable.
 *
 * @author Miquel Sas
 */
public class FieldList implements Iterable<Field> {
	...
	/**
	 * Validates the values against this field list checking that all field-value
	 * types are equal.
	 * 
