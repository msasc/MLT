...
/**
 * Interface that should implement back end persistence/procurement engines that
 * operate with records of views.
 *
 * @author Miquel Sas
 */
public interface Persistor {
	...
	/**
	 * Return a transaction to execute deletes, inserts or updates, to be commited
	 * or rolled back.
	 * 
	...
	/**
	 * Returns the maximum values of the argument field list with the filter
	 * criteria.
	 *
	 * @param criteria The filter criteria.
	...
	/**
	 * Select a list of records based on a selection criteria, returning the list
	...
	/**
	 * Returns the list of values that are the sum of the numeric argument fields
	...
	/**
	 * Update a set of fields with given values for the firlter criteria. The map of
	 * values can be keyed either by
