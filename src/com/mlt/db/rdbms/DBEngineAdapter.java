...
import com.mlt.db.rdbms.sql.AddCheck;
import com.mlt.db.rdbms.sql.AddField;
import com.mlt.db.rdbms.sql.AddForeignKey;
import com.mlt.db.rdbms.sql.AddPrimaryKey;
import com.mlt.db.rdbms.sql.CreateIndex;
import com.mlt.db.rdbms.sql.CreateSchema;
import com.mlt.db.rdbms.sql.CreateTable;
import com.mlt.db.rdbms.sql.Delete;
import com.mlt.db.rdbms.sql.DropConstraint;
import com.mlt.db.rdbms.sql.DropField;
import com.mlt.db.rdbms.sql.DropForeignKey;
import com.mlt.db.rdbms.sql.DropIndex;
import com.mlt.db.rdbms.sql.DropPrimaryKey;
import com.mlt.db.rdbms.sql.DropSchema;
import com.mlt.db.rdbms.sql.DropTable;
import com.mlt.db.rdbms.sql.Insert;
import com.mlt.db.rdbms.sql.Select;
import com.mlt.db.rdbms.sql.Update;

/**
 * A <code>DBEngineAdapter</code> represents the back-end system to which we
 * connect through a JDBC driver. This class addresses several problems faced
 * when building systems that aim to be as much independent of the underlying
 * database as possible.
 * <p>
 * <b>Type mapping and table creation</b>. Although JDBC drivers may include
 * helper classes or methods to map JDBC types to the names used to create
 * tables, this is always a particular and optional feature of the driver. Thus,
 * a parameterized type map to build <code>CREATE TABLE</code> statements is
 * necessary for the system to address table creation. Note that none of the
 * database access specifications (JDBC, ODBC!) has a solution for this problem
 * and tables are supposed to exist or to be created by other means or hand
 * written statements that are invalid applied to other database systems.
 * <p>
 * <b>Relational queries</b>. Unfortunately, relations have to be expressed in a
 * different way from one database to another. Explicit and implicit relations
 * should be supported for a system to be compatible. Explicit relations take
 * the form,
 * <p>
 * <code>
 * SELECT Detail.product_id, Product.description
 * <br>
 ...
 * </code>
 * <p>
 * <b>System functions.</b> System functions like the current date, time or
 * time-stamp unfortunately have different names for different databases. This
 * class addresses this issue by mapping database function names for the current
...
public abstract class DBEngineAdapter {
	...
	/**
	 * Gets the field definition to use in a <code>CREATE TABLE</code> statement,
	 * given a field.
	 *
	 ...
	 */
	protected final void setDriverClassName(String driverClassName) {
	 ...
	 */
	public void registerDriver() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
	...
	public String getFieldDefinitionSuffix(Field field) {
		...
		if (field.isCurrentDateTimeOrTimestamp()) {
			...
			if (!field.isNullable()) {
				if (field.getInitialValue() == null) {
					if (!field.isDate() && !field.isTime() && !field.isDateTime()) {
						b.append(" DEFAULT ");
	...
	/**
	 * Returns the add check statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the ADD CONSTRAINT ... CHECK
	 * statement.
	 *
	...
	/**
	 * Returns the add field statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the ALTER TABLE <i>table</i>
	 * ADD <i>field definition</i>
	 * statement.
	 *
	 * @param table The table.
	...
	/**
	 * Returns the add foreign key statement. This method is aimed to be overwritten
	 * if the database adapter has a different syntax for the ALTER TABLE
	 * <i>table</i> ADD FOREIGN KEY <i>field definition</i> statement.
	 *
	 * @param table      The table.
	...
	/**
	 * Returns the add primary key statement. This method is aimed to be overwritten
	 * if the database adapter has a different syntax for the ALTER TABLE ADD
	...
	/**
	 * Returns the create index statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the CREATE INDEX statement.
	 *
	...
	/**
	 * Returns the create table statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the CREATE TABLE statement.
	 *
	...
	/**
	 * Returns the delete statement. This method is aimed to be overwritten if the
	 * database adapter has a different syntax for the DELETE statement.
	 *
	 * @param table  The table.
	...
	/**
	 * Returns the drop field statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the ALTER TABLE <i>table</i>
	 * DROP COLUMN <i>field</i> statement.
	 *
	...
	/**
	 * Returns the drop constraint statement. This method is aimed to be overwritten
	 * if the database adapter has a different syntax for the ALTER TABLE
	 * <i>table</i> DROP CONSTRAINT <i>constraint</i> statement.
	 *
	 ...
	 * Returns the drop constraint statement. This method is aimed to be overwritten
	 * if the database adapter has a different syntax for the ALTER TABLE
	 * <i>table</i> DROP FOREIGN KEY statement.
	 *
	 * @param table      The table.
	...
	/**
	 * Returns the drop index statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the DROP INDEX statement.
	 *
	...
	/**
	 * Returns the drop primary key statement. This method is aimed to be
	 * overwritten if the database adapter has a different syntax for the ALTER
	 * TABLE <i>table</i> DROP PRIMARY KEY statement.
	 * 
	...
	/**
	 * Returns the drop schema statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the DROP TABLE statement.
	 *
	...
	/**
	 * Returns the drop table statement. This method is aimed to be overwritten if
	 * the database adapter has a different syntax for the DROP TABLE statement.
	 *
	 * @param table The table.
	...
	/**
	 * Returns the insert statement. This method is aimed to be overwritten if the
	 * database adapter has a different syntax for the INSERT INTO statement.
	 *
	 * @param table  The table.
	...
	/**
	 * Returns the select query. This method is aimed to be overwritten if the
	 * database adapter has a different syntax for the SELECT query.
	 *
	 * @param view The view.
	...
	/**
	 * Returns the update statement. This method is aimed to be overwritten if the
	 * database adapter has a different syntax for the UPDATE statement.
	 *
	 * @param table  The table.
	...
	/**
	 * Returns the massive update statement for the table, filter and field map
	 * values.
	 *
	 * @param table  The table.
	 * @param filter The filter.
	...
	/**
	 * Return a string representation of the date, valid to be used in an SQL
	 * statement.
	 *
	 * @param date The date.
	...
	/**
	 * Return a string representation of the time, valid to be used in an SQL
	 * statement.
	 *
	 * @param time The time.
	 * @return The SQL string representation.
	...
	/**
	 * Return a string representation of the time-stamp, valid to be used in an SQL
	 * statement.
	 *
	 * @par time-stamp The time-stamp.
	 * @return The SQL string representation.
	 */
	public abstract String toStringSQL(Timestamp timestamp);

	/**
	 * Return a string representation of the number, valid to be used in an SQL
	 * statement.
	 *
	...
	/**
	 * Return a string representation of the string, valid to be used in an SQL
	 * statement.
	 *
	...
	/**
	 * Return a string representation of the value valid to be used in an SQL
	 * statement.
	 *
