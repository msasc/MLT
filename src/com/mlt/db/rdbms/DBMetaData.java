...
public class DBMetaData {
	 ...
	 */
	private static Field createField(String name, String description, Types type, int length, int decimals, boolean primaryKey) {
	...
	public static FieldList getFieldListColumnInfo() {
		...
		fieldList
			.addField(createField("BUFFER_LENGTH", "Buffer length", Types.INTEGER, 0, 0, false));
		fieldList
			.addField(createField("DECIMAL_DIGITS", "Decimal digits", Types.INTEGER, 0, 0, false));
		fieldList
			.addField(createField("NUM_PREC_RADIX", "Num prec radix", Types.INTEGER, 0, 0, false));
		...
		fieldList
			.addField(createField("SQL_DATA_TYPE", "SQL data type", Types.INTEGER, 0, 0, false));
		fieldList.addField(
			createField("SQL_DATETIME_SUB", "SQL date time sub", Types.INTEGER, 0, 0, false));
		fieldList.addField(
			createField("CHAR_OCTET_LENGTH", "Char octet length", Types.LONG, 0, 0, false));
		fieldList.addField(
			createField("ORDINAL_POSITION", "Ordinal position", Types.INTEGER, 0, 0, true));
		fieldList.addField(createField("IS_NULLABLE", "Is nullable", Types.STRING, 5, 0, false));
		fieldList
			.addField(createField("DATA_TYPE_NAME", "Data type name", Types.STRING, 20, 0, false));
		return fieldList;
	}
	...
	public static FieldList getFieldListIndexInfo() {
		...
		fieldList.addField(
			createField("INDEX_QUALIFIER", "Index qualifier", Types.STRING, 40, 0, false));
		...
		fieldList.addField(
			createField("ORDINAL_POSITION", "Ordinal position", Types.INTEGER, 0, 0, false));
		...
		fieldList.addField(
			createField("FILTER_CONDITION", "Filter condition", Types.STRING, 128, 0, false));
		fieldList.addField(
			createField("INDEX_TYPE_DESC", "Index type desc", Types.STRING, 20, 0, false));
		return fieldList;
	}
	...
	public static FieldList getFieldListTypeInfo() {
		...
		fieldList
			.addField(createField("LITERAL_PREFIX", "Literal prefix", Types.STRING, 5, 0, false));
		fieldList
			.addField(createField("LITERAL_SUFFIX", "Literal suffix", Types.STRING, 5, 0, false));
		fieldList.addField(
			createField("CREATE_PARAMS", "ActionCreate params", Types.STRING, 20, 0, false));
		fieldList.addField(createField("NULLABLE", "Nullable", Types.INTEGER, 0, 0, false));
		fieldList
			.addField(createField("CASE_SENSITIVE", "Case sensitive", Types.BOOLEAN, 0, 0, false));
		fieldList.addField(createField("SEARCHABLE", "Searcheable", Types.INTEGER, 0, 0, false));
		fieldList.addField(
			createField("UNSIGNED_ATTRIBUTE", "Unsigned attribute", Types.BOOLEAN, 0, 0, false));
		fieldList.addField(
			createField("FIXED_PREC_SCALE", "Fixed prec scale", Types.BOOLEAN, 0, 0, false));
		fieldList
			.addField(createField("AUTO_INCREMENT", "Auto increment", Types.BOOLEAN, 0, 0, false));
		fieldList.addField(
			createField("LOCAL_TYPE_NAME", "Local type name", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("MINIMUM_SCALE", "Minimum scale", Types.INTEGER, 0, 0, false));
		fieldList
			.addField(createField("MAXIMUM_SCALE", "Maximum scale", Types.INTEGER, 0, 0, false));
		fieldList
			.addField(createField("SQL_DATA_TYPE", "SQL data type", Types.INTEGER, 0, 0, false));
		fieldList.addField(
			createField("SQL_DATETIME_SUB", "SQL date time sub", Types.INTEGER, 0, 0, false));
		...
		fieldList
			.addField(createField("DATA_TYPE_NAME", "Data type name", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("NULLABLE_DESC", "Nullable desc", Types.STRING, 20, 0, false));
		return fieldList;
	}
	...
	public static FieldList getFieldListForeignKeyInfo() {
		FieldList fieldList = new FieldList();
		fieldList
			.addField(createField("PKTABLE_CAT", "PK Table catalog", Types.STRING, 20, 0, true));
		fieldList
			.addField(createField("PKTABLE_SCHEM", "PK Table schema", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("PKTABLE_NAME", "PK Table name", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("PKCOLUMN_NAME", "PK Column name", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("FKTABLE_CAT", "FK Table catalog", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("FKTABLE_SCHEM", "FK Table schema", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("FKTABLE_NAME", "FK Table name", Types.STRING, 20, 0, false));
		fieldList
			.addField(createField("FKCOLUMN_NAME", "FK Column name", Types.STRING, 20, 0, false));
		...
		fieldList
			.addField(createField("DELETE_RULE", "ActionDelete rule", Types.INTEGER, 2, 0, false));
		...
		fieldList
			.addField(createField("DEFERRABILITY", "Deferrability", Types.INTEGER, 20, 0, false));
		return fieldList;
	}
	...
	/**
	 * Returns a record set with information about the imported keys of a table. In
	 * our db system theese are foreign
	...
	/**
	 * Returns a record set with information about the exported keys of a table. In
	 * our db system theese are referrers
	...
	public boolean existsSchema(String schema) throws SQLException {
		...
		for (int i = 0; i < recordSet.size(); i++) {
			...
			if (record.getValue(TABLE_SCHEMA).getString().toLowerCase()
				.equals(schema.toLowerCase())) {
				return true;
			}
		}
		return false;
