...
/**
 * An ALTER TABLE ADD CONSTRAINT name CHECK (condition) builder to apply the
 * constraints related to the field.
 *
 * @author Miquel Sas
 */
public class AddCheck extends Statement {
	...
	public String toSQL() {
		...
		if (getField().getMaximumValue() == null && getField().getMinimumValue() == null
