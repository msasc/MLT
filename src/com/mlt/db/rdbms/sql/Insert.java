...
public class Insert extends Statement {
	...
	/**
	 * Sets the list of fields to be updated. If not set, the fields of the table
	 * are used instead.
	 *
	...
	/**
	 * Adds a list of values to build an insert statement of the form INSERT INTO
	 * table ( fields ) VALUES ( values ).
	 * This method can be called several times to create several insert operations.
	 * Obviously the values must correspond
	 * to the fields.
	 *
	...
	/**
	 * Adds the list of values to build an insert statement of the form INSERT INTO
	 * table ( fields ) VALUES ( values ) using the values given in the argument
	 * record. If the fields are not set and record has fields, the fields are taken
	 * from the record. Obviously the values in the record must correspond to the
	 * fields if already set.
	 *
	...
	/**
	 * Sets the select query to build an insert statement of the form INSERT INTO
	 * table ( fields ) SELECT ( query ).
	 *
	...
	public String toSQL() {
		...
		if (record == null && values == null && select == null) {
			throw new IllegalStateException(
				"Malformed INSERT query: need record, values or select");
		}
		...
		if (select != null && fields == null) {
			throw new IllegalStateException(
				"Malformed INSERT query: fields are needed for a select");
		}
