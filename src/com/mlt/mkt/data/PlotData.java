...
public class PlotData implements Iterable<DataList> {
	...
	/**
	 * A boolean that indicates if the minimum value, when it is greater tthan zero, should be forced to zero. This is
	 * necessary when plotting histograms on the volume.
	 */
	 ...
	 * added, and subsequent indicator lists are considered on chart indicators.</li>
