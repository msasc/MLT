...
public abstract class HistoryManager {
	 ...
	 * @throws ServerException If a server error occurs.
	 */
	public abstract Data getData(Instrument instrument, Period period, OfferSide offerSide, int shift)
	throws ServerException;
	 ...
	 * @throws ServerException
	 */
	public Data getLastData(Instrument instrument, Period period, OfferSide offerSide, Filter filter)
	throws ServerException {
	 ...
	 * @throws ServerException If a server error occurs.
	 */
	public abstract List<Data> getDataList(Instrument instrument, Period period, OfferSide offerSide, Filter filter,
	 ...
	 * @throws ServerException If a server error occurs.
	 */
	public abstract DataIterator getDataIterator(Instrument instrument, Period period, OfferSide offerSide,
	Filter filter, long from) throws ServerException;
	 ...
	 */
	public abstract DataIterator getDataIterator(Instrument instrument, Period period, OfferSide offerSide,
	Filter filter, long from, long to) throws ServerException;
}
