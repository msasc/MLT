...
/**
 * Utilities to read/write from an input/output stream.
 *
 * @author Miquel Sas
 */
public interface IO {
	...
	/**
	 * Read a boolean throwing an IOException if an attempt to pas the end of stream
	 * has been made.
	 * 
	 * @param is The input stream.
	...
	/**
	 * Read a byte throwing an IOException if an attempt to pas the end of stream
	 * has been made.
	 * 
	 * @param is The input stream.
