...
/**
 * Wraps the <i>SAXParser</i> to handler events with the more simple and
 * convenient <i>ParserHandler</i>.
 * 
 * @author Miquel Sas
 */
public class Parser {
	 ...
	 */
	public void parse(File file, ParserHandler handler) throws ParserConfigurationException, SAXException, IOException {
	 ...
	 * @throws IOException                  If an IO error occurs.
	 */
	public void parse(InputStream is, ParserHandler handler) throws ParserConfigurationException, SAXException, IOException {
