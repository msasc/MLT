...
public class XMLWriter {
	...
	public XMLWriter(File file)
		...
		OutputStreamWriter outputStreamWriter = new OutputStreamWriter(fo, getEncoding());
		printWriter = new PrintWriter(outputStreamWriter);
	}

	/**
	 * Constructor assigning the destination writer.
	 * 
	...
	/**
	 * Returns the first line header that indicates the version and the file
	 * encoding.
	 * 
	 ...
	 * 
	 * @param tag               The tag to print.
	 * @param emptyTag          A boolean that indicates whether the tag is empty,
	 *                          ie it has no children.
	 * @param attributesNewLine A boolean that indicates whether attributes should
	...
	public void printTagWithOptions(
		...
		// Push the tag onto the stack if the tag is not empty and should be closed
		// after.
		if (!emptyTag) {
			stack.push(tag);
		}
